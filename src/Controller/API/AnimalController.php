...
class AnimalController  extends AbstractController
{
  ...
  public function getSearchResult(Request $request, AnimalRepository  $animalRepository)
  {
    try {
  ...
  public function setPredictive(Request $request, AnimalRepository  $animalRepository)
  {
    try {
