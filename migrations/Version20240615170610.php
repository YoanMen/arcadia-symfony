 ...
 */
final class Version20240615170610 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('CREATE TABLE animal_food (id INT AUTO_INCREMENT NOT NULL, employee_id INT NOT NULL, date DATETIME NOT NULL COMMENT \'(DC2Type:datetime_immutable)\', food VARCHAR(60) NOT NULL, quantity NUMERIC(5, 2) NOT NULL, INDEX IDX_931568C38C03F15C (employee_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE animal_report (id INT AUTO_INCREMENT NOT NULL, animal_id INT NOT NULL, veterinary_id INT NOT NULL, date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', statut VARCHAR(60) NOT NULL, food VARCHAR(60) NOT NULL, quantity NUMERIC(5, 2) NOT NULL, detail VARCHAR(255) DEFAULT NULL, INDEX IDX_7EDEB2588E962C16 (animal_id), INDEX IDX_7EDEB258D954EB99 (veterinary_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE habitat_comment (id INT AUTO_INCREMENT NOT NULL, habitat_id INT NOT NULL, veterinary_id INT NOT NULL, date DATE NOT NULL COMMENT \'(DC2Type:date_immutable)\', detail VARCHAR(255) NOT NULL, INDEX IDX_C86D6DCEAFFE2D26 (habitat_id), INDEX IDX_C86D6DCED954EB99 (veterinary_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        $this->addSql('CREATE TABLE habitat_image (id INT AUTO_INCREMENT NOT NULL, habitat_id INT NOT NULL, image_name VARCHAR(255) DEFAULT NULL, image_size INT DEFAULT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_9AD7E031AFFE2D26 (habitat_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
        ...
        $this->addSql('CREATE TABLE service_image (id INT AUTO_INCREMENT NOT NULL, service_id INT NOT NULL, image_name VARCHAR(255) DEFAULT NULL, image_size INT DEFAULT NULL, updated_at DATETIME DEFAULT NULL COMMENT \'(DC2Type:datetime_immutable)\', INDEX IDX_6C4FE9B8ED5CA9E6 (service_id), PRIMARY KEY(id)) DEFAULT CHARACTER SET utf8mb4 COLLATE `utf8mb4_unicode_ci` ENGINE = InnoDB');
