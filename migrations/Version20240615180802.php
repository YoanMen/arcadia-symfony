 ...
 */
final class Version20240615180802 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE animal_food ADD animal_id INT NOT NULL');
    ...
    public function down(Schema $schema): void
    {
        ...
        $this->addSql('DROP INDEX IDX_931568C38E962C16 ON animal_food');
        $this->addSql('ALTER TABLE animal_food DROP animal_id');
    }
}
